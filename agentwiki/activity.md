...
<!-- agentwiki:facts id="summary" hash="aa0c09e8bcde" -->
- **Branch:** `main` at `d815790`
- **Commits (last 90 days):** 14
- **Active contributors (last 90 days):** 1
<!-- /agentwiki:facts -->

## Current focus

<!-- agentwiki:prose slot="current-focus" status="fresh" facts-hash="aa0c09e8bcde" hint="Summarize what the team is currently working on, based on the hot files and recent commit messages below." -->
...
<!-- agentwiki:facts id="hot-files" hash="aa0c09e8bcde" -->
| File | Commits (90d) |
| --- | --- |
| `.github/workflows/build.yml` | 9 |
| `agentwiki/activity.md` | 3 |
| `agentwiki/quickstart.md` | 3 |
| `chart/Chart.yaml` | 3 |
| `chart/values.yaml` | 3 |
| `agentwiki/.agentwiki.json` | 2 |
...
<!-- agentwiki:facts id="recent-commits" hash="aa0c09e8bcde" -->
- `d815790` 2026-09-13 — wiki: 基于重写后的历史刷新 facts _(Liqiang Zhang)_
- `0226181` 2026-09-13 — wiki: 精修 prose，去除内部部署细节与失效提交引用 _(Liqiang Zhang)_
- `cdf25bb` 2026-09-13 — docs: 接入 agentwiki，初始化项目 wiki 与 agent 配置 _(Liqiang Zhang)_
